        ...
        @endif
            <form class="form-horizontal" role="form" method="POST" action="{{ route('subject.store') }}">
                ...
                <div class="form-group{{ $errors->has('subject_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="subject_name" value="{{ old('subject_name') }}" type="text" class="form-control" name="subject_name">
                ...
                <div class="form-group{{ $errors->has('subject_code') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="subject_code" value="{{ old('subject_code') }}" type="text" class="form-control" name="subject_code">
                ...
                <div class="form-group{{ $errors->has('subject_credit') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="subject_credit" value="{{ old('subject_credit') }}" type="text" class="form-control" name="subject_credit">
